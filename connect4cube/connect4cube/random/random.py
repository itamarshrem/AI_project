...
from connect4cube.connect4cube.hardware.button_events import ButtonEvents
from connect4cube.connect4cube.hardware.cube import Cube, get_empty_cube_buffer
from connect4cube.connect4cube.hardware.util import is_a_raspberry
...
class Random(App):
    ...
    def get_random_wheel(self):
        random_wheel = [[[random.randint(0, 255) for _ in range(5)] for _ in range(5)] for _ in range(5)]
        return random_wheel
