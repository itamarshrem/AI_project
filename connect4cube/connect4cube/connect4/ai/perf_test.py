...
from connect4cube.connect4cube.connect4.ai.perf_testdata_gen import hardname, easyname
from connect4cube.connect4cube.connect4.ai.think_ahead import negamax_full, WIN_SCORE
